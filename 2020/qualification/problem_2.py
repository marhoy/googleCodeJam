...
def main():
    ...
    for case in range(1, cases + 1):
        ...
        for digit in digits:
            ...
            # Number of opening parathesis we need for this digit
            n_needed = int(digit) - n_open

            # For debugging
            LOG.debug("Digit: {}, n_open: {}, n_needed: {}".format(
                digit, n_open, n_needed))

            # Append paranthesis as needed
            if n_needed > 0:
                output += "(" * n_needed
            elif n_needed < 0:
                output += ")" * abs(n_needed)
            ...
            # Keep track of number of open parathesis
            n_open += n_needed

        # Add closing parathesis at the end as needed
        output += ")"*n_open
